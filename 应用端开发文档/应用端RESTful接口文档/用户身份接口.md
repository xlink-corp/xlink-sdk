...
3. [使用手机注册新账号](#phone_register)
4. [发送手机验证码](#send_sms_verifycode)
5. [登录与认证](#user_auth)
...
12. [上传用户头像](#upload_avatar)
13. [设置用户头像](#set_avatar)
14. [附录](#appendix)
...
### **<a name="phone_register">3.使用手机注册新账号</a>**
...
### **<a name="send_sms_verifycode">4.发送手机验证码</a>**
...
Content
	...
	备注：remark和nickname,tags都可以不是必须项
...
### **<a name ="upload_avatar">11.上传用户头像</a>**
