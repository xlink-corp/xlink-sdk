...
| expire | 否 |　指令过期时间, 只针对需要回写的指令, 默认为当前时间, 例：2014-10-09T08:15:40.843Z
...
```
POST /v2/product/{product_id}/devices/geography_multiple
```
...
字段 | 是否必须 | 描述
---- | ---- | ----
type  | 是 | 支持spherical(圆形区域),polygon(坐标点集合)
coord | 是 | 坐标点
