...
45. [生成单个设备二维码](#generate_device_qrcode)
46. [获得固件版本列表POST](#listProductVersion_post)
47. [获取固件版本](#getProductVersion)
...
expression | 否 | string, 虚拟数据端点表达式, 假如要引用其他数据端点:@index@ + 1, 加入要引用所属产品拓展属性则: #property# + 2
...
expression | 是 | string, 虚拟数据端点表达式, 假如要引用其他数据端点:@index@ + 1, 加入要引用所属产品拓展属性则: #property# + 2
...
### **<a name="generate_device_qrcode">45. 生成单个设备二维码</a>**
...
### **<a name="listProductVersion_post">46.获得固件版本列表</a>**
...
### **<a name="getProductVersion">47.获取固件版本</a>**
...
### **<a name="addDeviceProperties">48.设置产品扩展属性</a>**
