...
39. [获取设备的订阅信息](#device_subscribe)
40. [通过csv批量导入设备](#batchImportDevice)
41. [查询导入设备历史纪录](#batchImportDeviceRecordList)
42. [查询导入设备记录详情](#getBatchImportDeviceRecord)
43. [批量导出设备二维码](#batch_export_device_qrcode)
...
### **<a name="device_subscribe">39. 获取设备的订阅信息</a>**
...
### **<a name="batchImportDevice">40.通过csv批量导入设备</a>**
...
### **<a name="batchImportDeviceRecordList">41.查询导入设备历史纪录</a>**
...
### **<a name="getBatchImportDeviceRecord">42.查询导入设备记录详情</a>**
...
### **<a name="batch_export_device_qrcode">批量导出设备二维码</a>**
