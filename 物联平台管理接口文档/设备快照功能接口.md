...
| statistic_mode | 是 | 各个数据端点统计方式, 见[附录](#snapshot_statistic_rule_mode)。 |
| statistic_dimension | 是 | 统计维度, 见[附录](#snapshot_statistic_rule_dimension)。 |
...
```
GET /v2/product/{product_id}/snapshot/{snapshot_id}/statistic_rule
```
...
### <a name="snapshot_statistic_rule_dimension">快照统计维度</a>
